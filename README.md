...
**Warning**: it's all broken, it barely works and when it works it breaks something else haha, it's a script I made in 10 minutes so I wouldn't have to pass all the cards by hand and avoid complications, **worried about performance? Pfff... keep your fingers crossed that your computer doesn't hang up**.
